			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.CaoYanghua.model.Order o=(com.CaoYanghua.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.CaoYanghua.dao.UserDao userDao=new com.CaoYanghua.dao.UserDao();
						...
						<%
							...
							String paymentType=com.CaoYanghua.model.Payment.findByPaymentId(con,n);
							 %>
